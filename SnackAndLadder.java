            ...
            switch (check_option) {
                ...
                case ladder:
                    ...
                    if (initial_position <= final_position) {
                        ...
                        initial_position -= roll_die;
                        System.out.println("Its a LADDER! But the player cannot move ahead by " + roll_die
                                + " positions since it exceeds the final position.");
                    }
                    break;
                case snake:
                    initial_position -= roll_die;
                    System.out.println("Its a SNAKE! Player moves behind by " + roll_die);
                    break;
            }
